    ...
    <div  id="card-public-wrapper">
      <div class="card-simple" id="card-public">
        ...
        <div class="flex-box-horizontal flex-box">
          ...
          <div style="width:55%"><p> > <a v-on:click="togglePilot">pilot: summer 2021</a></p></div>
        </div>
      ...
      <div v-if="readMore" class="card-simple" id="card-read-more">
        ...
        <p>
          > Each iteration will start with every participant contributing one reading to the reading pool.
          <br> > The length of the reading cycle depends on the number of participants, hence the number of readings contributed to the group.
          <br> > Throughout the course of the reading group, participants would receive a different weekly reading from the pool,
          annotate it in their own ways, and return it to the server. In later circulations, participants would start seeing
          accumulative annotations left by former participants and emerging conversations on papers.
          Annotations are noted anonymously to facilitate open and non-discriminatory conversations.
          At the end of all circulations, readings will be returned to their original contributors with layers of traces,
          notes and dialogues left by others. To wrap up, all participants will be invited to a virtual/in-person meet-up for reflection and mingling.
          <br> > As the process largely occurs anonymously for most of the time, there will be social prompts each week to foster a sense of community.
      ...
      <div v-if="showPilot" class="card-simple" id="card-about-us">
        ...
        <div style="border-bottom: var(--border)">
          <p class="quote text-center" style="font-size: 0.8rem">
            “The aggregative nature of Chimera made participating as a reader especially exciting!
            Texts that have been published for years were suddenly made mutable through close reading and annotation.
            Seeing the notes accumulate over time and the meaning of the texts change each week because of that was
            truly stimulating. Being in anonymous intellectual conversation and debate in the margins was liberating
        ...
        <div style="border-bottom: var(--border)">
          ...
          <p class="text-center">
            Kat Huang<br>
            Weihan Jiang<br>
            <a href="https://www.shannonljohnson.com/" target="_blank">Shannon L. Johnson</a><br>
            Kii Kang<br>
            <a href="https://kwanq.cargo.site/" target="_blank">Kwan Q Li</a><br>
            <a href="https://www.tzutung.com/" target="_blank">Lee Tzu Tung</a><br>
            Meriam Soltan
          </p>
        </div>
        <h2>DOCUMENTATION</h2>
        <p class="text-center">
          <a href="https://vimeo.com/592175448/5a0182a663" target="_blank">Video Journal</a><br>
