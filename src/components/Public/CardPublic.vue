<template>
    <div  id="card-public-wrapper">
      <div class="card-simple" id="card-public">
        ...
        <p>
          <i><center>"How can we embody rhizomatic knowledge in hybrid realities?"</center></i><br>
          ...
          Funded by the <a href="http://transmedia.mit.edu/" target="_blank">Transmedia Storytelling Initiative</a>,
